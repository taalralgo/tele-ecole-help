export function IconAfrica({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        d="M9.2 11.1a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4Zm7.2-.8a2.4 2.4 0 1 0 0-4.8 2.4 2.4 0 0 0 0 4.8ZM3.8 19v-1.3c0-2.7 2.4-4.8 5.4-4.8s5.4 2.1 5.4 4.8V19H3.8Zm11.5-6.7c2.8 0 4.9 1.8 4.9 4.2v1h-3.6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export function IconBank({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M3 10 12 4l9 6M5 10v8h14v-8M8 18v-4M12 18v-4M16 18v-4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconPhoneScan({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <rect
        ...
        strokeWidth="1.5"
      />
      <path d="M11 18h2" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
...
export function IconPhone({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M6.6 10.8c1.6 3.1 3.5 5 6.6 6.6l2.2-2.2c.3-.3.7-.4 1.1-.2 1.2.4 2.5.7 3.8.7.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.8 21 3 13.2 3 3.7c0-.6.4-1 1-1h3.4c.6 0 1 .4 1 1 0 1.3.2 2.6.7 3.8.1.4 0 .8-.3 1.1l-2.2 2.2Z" />
    </svg>
  );
}
