export const WAVE_PAY_URL = "https://pay.wave.com/mqr/F0I71H-9" as const;
export const ORANGE_MONEY_PAY_URL = "https://sugu.orange-sonatel.com/bill/partners/423" as const;
